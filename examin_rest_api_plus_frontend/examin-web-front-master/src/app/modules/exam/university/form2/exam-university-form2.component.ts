...
@Component({
    selector: 'app-exam-university-form2',
    templateUrl: './exam-university-form2.component.html'
})
export class ExamUniversityForm2Component implements OnInit {
    ...
    buildForm() {
        this.examUniversityForm2 = this.formBuilder.group({
    ...
    updateForm(university: University) {
        ...
        this.examUniversityForm2.patchValue({
    ...
    onSubmit() {
        ...
        if (this.examUniversityForm2.invalid) {
            return this.toastr.error('Error in the form, please check!');;
        }

        this.inProcess = true;
        this.apiService.post(`exam/${this.examId}/university`, this.examUniversityForm2.value).subscribe(
            data => {
